...
public class Ship
{
    ...
    /* Static function to create ships */
    ...
    /* Target should be the ship's head for placement, or anchor for rotation */
        ...
        switch (operation)
        {
            case "place":
                ...
                if (mOrientation == 2 && xTarget + mLength > 10 || // 1==Vertical, 2==Horizontal
                    mOrientation == 1 && yTarget + mLength > 10)
                {
                    return false;
                }
                return true;
    ...
    {
        // First check if the ship's head is in a valid location after translation
        ...
        while (mCells.Count < mLength)
        {
            ...
            mCells[mCells.Count - 1].mIncludedShips.Add(this);
